  ...
  public static String fakeReview(String fileName) {
    ...
    while (i < review.length()) {
        ...
        if (review.charAt(i) == '*') {
            ...
            String adjective = review.substring(i + 1, end);

            
            String replacement = "";
            if (0.1>= sentimentVal(adjective) && sentimentVal(adjective) >=0 ) {
                replacement = randomPositiveAdj();
            } else if (-0.1<= sentimentVal(adjective) && sentimentVal(adjective) <=0) {
