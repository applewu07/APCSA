public class Elby {
    ...
    public String getResponse(String statement) {
        String response = "";
        String trimmedResponse = statement.trim();
        ...
        if (trimmedResponse.length () == 0){
            ...
            response = "She sounds like she is a nice person! ";
        }
            ...
            response = "Having a friend is nice! What is their name?";
        }
        else if (findKeyword(statement, "art", 0) >= 0) {
            response = "Art is amazing! Who is your favourite artist ?";
        }
    ...
    private String getRandomResponse() {
        ...
        if (whichResponse == 0) {
            ...
            response = "Thats unfortunate. ";
        }
        else if (whichResponse == 5) {
            response = "How can I help?" ;
        }
        else if (whichResponse == 6) {
            response = "Sounds interesting. Let me think about it and get back to you.";
        }
        else if (whichResponse == 7) {
            response = "I might be able to help.";
        }
